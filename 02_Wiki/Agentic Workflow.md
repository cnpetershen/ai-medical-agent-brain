...
- 让 [[医疗AI Agent|医疗 Copilot Agent]] 能根据场景调度不同 Workflow。
...
因此，本项目需要 Agentic Workflow 作为中间形态：既保留 [[医疗AI Agent]] 的任务理解、上下文组织和工具调用能力，又通过 Workflow 明确任务范围、执行步骤和医生确认节点。
...
- [[医疗AI Agent]]：Agentic Workflow 中的智能调度中枢。
...
本节点只讨论本项目中的 Agentic Workflow，不展开通用智能体框架比较。后续技术节点如 [[医疗AI Agent]]、[[RAG]]、[[Tool Calling]]、[[Memory]] 应服务于本项目的 Workflow 设计。
